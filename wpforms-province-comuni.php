...
function wpfpc_select2_style(): void {
    ...
    /* Contenitore principale: eredita tutto dal select WPForms sottostante */
    ...
    /* Testo selezionato — centrato verticalmente */
    ...
    (function ($) {
        ...
        function initForm(cfg) {
            ...
            function caricaComuni(sigla) {
                // Distrugge Select2 prima di modificare il select
                if ($.fn.select2 && $(selCom).hasClass('select2-hidden-accessible')) {
                    $(selCom).select2('destroy');
                }
